...
namespace SpaMerkezleri.Controllers
{
    ...
    public class BlogController : Controller
    {
        ...
        public IActionResult Index(string categoryName)
        {
            ...
            ViewBag.TotalBlogs = values.Count(); // Filtrelenmiş toplam blog sayısını hesaplama
            ViewBag.Img = _context.AboutMes.FirstOrDefault()?.AboutBlogImg ?? "/images/about/default.png";
            ViewBag.Categories = _context.Blogs.Select(c => c.CategoryName).Distinct().ToList();
        ...
        {
            int pageSize = 8;
            var blogs = _context.Blogs.Include(x => x.AppUser).AsQueryable();
